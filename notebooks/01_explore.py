...
fig.suptitle('AVIRIS-NG Delta-X — Exploratory Data Analysis',
...
axes[1, 0].plot(wavelengths, sig1,
                label=f'Pixel {tuple(sample1)}', color='blue',  linewidth=1.5)
axes[1, 0].plot(wavelengths, sig2,
                label=f'Pixel {tuple(sample2)}', color='green', linewidth=1.5)
axes[1, 0].plot(wavelengths, sig3,
                label=f'Pixel {tuple(sample3)}', color='red',   linewidth=1.5)
...
axes[1, 1].plot(wavelengths, mean_spectrum,
                color='black', linewidth=2, label='Mean')
axes[1, 1].fill_between(wavelengths,
